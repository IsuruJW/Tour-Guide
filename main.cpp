...
void loginmenu(){           // Login screen
    ...
    cout<<"\t\t| 3. New User Registration    | "<<endl;
    cout<<"\t\t| 4. New Driver Registration  | "<<endl;
...
void update_driver(int index){
	...
	cout << "8.Rate per Kilometer: "<<endl;
    cout << "9.Exit:\n "<<endl;
...
void driver_register(){     // Function for driver registration
    ...
    string regDriver,regPass,regName,regTP,regMnB,regNumPlate,regRate,regLocation,availability;
	...
	Driver.push_back({regDriver,regPass,regName,regTP,regMnB,regNumPlate,regLocation,regRate,availability});
	update_files();
